...
let mainImg=document.querySelector('.section9-div2 img');
let thumbImg=document.querySelectorAll('.section9-div3 img');
let thumbnailActive=thumbImg[0];
thumbnailActive.classList.add('thumbnail-active')
thumbImg.forEach((thumbnail)=>{
    thumbnail.addEventListener('click',function(){
        mainImg.src=thumbnail.src;
        thumbnailActive.classList.remove('thumbnail-active');
        thumbnail.classList.toggle('thumbnail-active');
